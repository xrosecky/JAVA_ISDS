...
public class MessageEnvelope implements Serializable {
	...
	public MessageEnvelope(MessageType type, DataBox sender, DataBox recipient,
			String id, String annotation) {
	...
	public MessageEnvelope(MessageType type, DataBox sender, DataBox recipient,
			String id, String annotation, LegalTitle legalTitle,
	...
	public String toString() {
		return String.format(
				"odesilatel:%s prijemce:%s id zpravy:%s predmet zpravy:%s",
