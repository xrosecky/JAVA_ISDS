...
public enum DataBoxEnvironment {
    ...
    TEST ("ws1.czebox.cz", "ws1c.czebox.cz", "ws2.czebox.cz", "ws2c.czebox.cz"),
    PRODUCTION ("ws1.mojedatovaschranka.cz", "ws1c.mojedatovaschranka.cz", "ws2.mojedatovaschranka.cz", "ws2c.mojedatovaschranka.cz");
    ...
    DataBoxEnvironment(String basicURL, String clientCertURL, String basicURLVODZ, String clientCertURLVODZ) {
