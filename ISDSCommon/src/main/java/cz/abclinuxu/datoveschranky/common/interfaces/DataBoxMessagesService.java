...
public interface DataBoxMessagesService {
	 ...
	 * 
	 * @param from
	 *            čas dodání do ISDS od
	 * @param to
	 *            čas dodání do ISDS do
	 * @param filter
	 *            filter na stav zpráv, null nebo prázdná množina vybere všechny
	 *            zprávy, v opačném případě se vyberou zprávy se stavem, který
	 *            je obsažen v množině filter.
	 * @param offset
	 *            číslo první požadavané obálky (indexuje se od jedne!!!)
	 * @param limit
	 *            počet vrácených obálek
	 * 
	 * @throws DataBoxException
	 *             při vracení seznamu nastala chyba
	 * 
	 */
	 ...
	 * 
	 * @param envelope
	 *            obálka zprávy u které chceme znát has
	 * 
	 * @throws DataBoxException
	 */
	...
	/**
	 * Stáhne doručenku zprávy ve formátu PKCS7 a uloží ji do výstupního proudu.
	 * Tento formát je vhodný pro zálohování. PKCS7 je binární formát, žádné XML
	 * ani zfo soubor. Po odstranění podpisu je výsledek XML.
	 * 
	 * @param envelope
	 *            obálka zprávy, ke které má stáhnout přílohy
	 * @param os
	 *            kam se má uložit
	 * 
	 * @throws DataBoxException
