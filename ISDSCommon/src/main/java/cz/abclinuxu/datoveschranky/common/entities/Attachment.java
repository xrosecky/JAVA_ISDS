...
public class Attachment implements Serializable {
	 ...
	 * 
	 * @param newDescr
	 *            popis zprávy, povinný, maximální délka 256 znaků.
	 * 
	 */
	...
	/**
	 * Nastaví druh písemnosti (meta type), v ISDS jsou povolené main,
	...
	public String toString() {
		return String.format("Popis:%s MimeType:%s MetaType:%s",
				this.description, this.mimeType, this.metaType);
	}
